...
namespace HAHATalk.ViewModels
{
    ...
    public partial class SignupControlViewModel
    {
        ...
        private void Save()
        {
            ...
            // MSSQL의 경우 
            _accountRepository.MSSQL_Save(account);
        ...
        private bool IsValidSignup()
        {
            ...
            if(isNullText(nameof(Nickname), Nickname))
            {
                return false;
            }

            if (isNullText(nameof(CellPhone), CellPhone))
            {
                return false;
            }

            if (isNullText(nameof(Password), Password))
            {
                return false;
            }

            if (isNullText(nameof(PasswordConfirm), PasswordConfirm))
            {
                return false;
            }
