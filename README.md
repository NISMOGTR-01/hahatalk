...
본 프로젝트는 **'까불이 코더'**님의 WPF 카카오톡 클론 코딩 프로젝트를 마중물 삼아, 실무적인 관점에서 **아키텍처 개선 및 기능 확장**을 진행하고 있는 프로젝트입니다. 단순 UI 모방을 넘어, **현업(MES/ERP) 환경에 최적화된 MSSQL 연동과 안정적인 예외 처리 구조**를 구축하는 데 중점을 두었습니다.
